...
# dataset
data_features = ['img', 'pts', 'box_size', 'anchor', 'sem_one_hot', 'ins_one_hot' , 'part_id', 'total_parts_cnt' , 'similar_parts_cnt', 'mask' , 'parts_cam_dof' ,'shape_id', 'view_id', 'similar_parts_edge_indices']

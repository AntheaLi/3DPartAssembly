...
def train(conf):
    ...
    train_dataset = PartNetShapeDataset(conf.category, conf.data_dir, data_features, data_split="trainone", \
    ...
    val_dataset = PartNetShapeDataset(conf.category, conf.data_dir, data_features, data_split="valone", \
            max_num_mask = conf.max_num_parts, max_num_similar_parts=conf.max_num_similar_parts, img_size=conf.img_size, on_kaichun_machine=conf.on_kaichun_machine)

...
def forward(batch, data_features, network, conf, \
    ...
    print(input_box_size.shape, input_pts.shape)
    ...
    if conf.normalize: 
        pred_masks = network(input_img, input_pts, input_sem_one_hot, input_ins_one_hot, input_box_size, input_total_part_cnt)
    else:
